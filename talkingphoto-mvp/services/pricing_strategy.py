...
class PricingTier(Enum):
    """Pricing tiers with HeyGen premium support"""
    FREE = "free"
...
class PricingStrategy:
    ...
    def _load_base_pricing(self) -> Dict:
        """Load base pricing structure with HeyGen premium tiers"""
        return {
            PricingTier.FREE: {
                "monthly_price": 0.0,
                "yearly_price": 0.0,
            ...
            PricingTier.STANDARD: {
                "monthly_price": 19.0,
                "yearly_price": 190.0,  # 2 months free
                "credits": 50,
                "provider": "veo3",
                "cost_per_video": 0.38,  # $19/50 videos
                "features": [
                    "50 video generations per month",
                    "Veo3 AI technology (₹0.15/second)",
            ...
            PricingTier.PREMIUM: {
                "monthly_price": 29.0,
                "yearly_price": 290.0,  # 2 months free
                "credits": 25,
                "provider": "heygen",
                "cost_per_video": 1.16,  # $29/25 videos
                "premium_multiplier": 4.0,  # 4x price for premium quality
                "features": [
                    "25 premium video generations per month",
                    "HeyGen AI technology (professional avatars)",
                    "1080p Full HD quality",
            ...
            PricingTier.ENTERPRISE: {
                ...
                "credits": 200,
                "provider": "both",  # Access to both Veo3 and HeyGen
                "cost_per_video": 0.495,  # $99/200 videos
                "features": [
                    "200 video generations per month",
                    "Both Veo3 & HeyGen access",
                    "4K Ultra HD quality",
                    "Full professional avatar library",
