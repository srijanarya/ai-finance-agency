...
import { AlertType, AlertPriority, AlertStatus } from '../entities/market-alert.entity';
...
export class CreateAlertDto {
  ...
  @ApiProperty({ description: 'Target price (for price alerts)', required: false })
  @IsOptional()
  @IsNumber()
  targetPrice?: number;
  ...
  @ApiProperty({ description: 'Alert priority', enum: AlertPriority, required: false })
  @IsOptional()
...
export class UpdateAlertDto {
  ...
  @ApiProperty({ description: 'Alert conditions in JSON format', required: false })
  @IsOptional()
  @IsObject()
  conditions?: Record<string, any>;
  ...
  @ApiProperty({ description: 'Alert status', enum: AlertStatus, required: false })
  @IsOptional()
  @IsEnum(AlertStatus)
  status?: AlertStatus;
...
export class GetAlertsDto {
  @ApiProperty({ description: 'Alert status filter', enum: AlertStatus, required: false })
  @IsOptional()
  @IsEnum(AlertStatus)
  status?: AlertStatus;
  ...
  @ApiProperty({ description: 'Alert type filter', enum: AlertType, required: false })
  @IsOptional()
  @IsEnum(AlertType)
  alertType?: AlertType;

  @ApiProperty({ description: 'Priority filter', enum: AlertPriority, required: false })
  @IsOptional()
  @IsEnum(AlertPriority)
  priority?: AlertPriority;
}
...
export class BulkCreateAlertsDto {
  @ApiProperty({ description: 'Array of alerts to create', type: [CreateAlertDto] })
  @IsArray()
...
export class AlertResponseDto {
  ...
  @ApiProperty({ description: 'Price when alert was triggered', required: false })
  triggeredPrice?: number;

  @ApiProperty({ description: 'Number of times alert was triggered' })
  triggerCount: number;

  @ApiProperty({ description: 'Last notification sent timestamp', required: false })
...
export class AlertTestDto {
  @ApiProperty({ description: 'Mock price to test alert condition', required: false })
  @IsOptional()
  @IsNumber()
  mockPrice?: number;

  @ApiProperty({ description: 'Mock volume to test alert condition', required: false })
  @IsOptional()
  @IsNumber()
  mockVolume?: number;

  @ApiProperty({ description: 'Mock percentage change to test alert condition', required: false })
  @IsOptional()
  @IsNumber()
