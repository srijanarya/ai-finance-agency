...
goog.exportSymbol('proto.treum.common.OperationResult', null, global);
 ...
 * @constructor
 */
proto.treum.common.OperationResult = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.treum.common.OperationResult, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.treum.common.OperationResult.displayName = 'proto.treum.common.OperationResult';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.treum.common.OperationResult.prototype.toObject = function(opt_includeInstance) {
  return proto.treum.common.OperationResult.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.treum.common.OperationResult} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.treum.common.OperationResult.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.treum.common.OperationResult}
 */
proto.treum.common.OperationResult.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.treum.common.OperationResult;
  return proto.treum.common.OperationResult.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.treum.common.OperationResult} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.treum.common.OperationResult}
 */
proto.treum.common.OperationResult.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.treum.common.OperationResult.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.treum.common.OperationResult.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.treum.common.OperationResult} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.treum.common.OperationResult.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {boolean}
 */
proto.treum.common.OperationResult.prototype.getSuccess = function() {
...
/**
 * @param {boolean} value
 * @return {!proto.treum.common.OperationResult} returns this
 */
proto.treum.common.OperationResult.prototype.setSuccess = function(value) {
 ...
 * @return {string}
 */
proto.treum.common.OperationResult.prototype.getMessage = function() {
 ...
 * @return {!proto.treum.common.OperationResult} returns this
 */
proto.treum.common.OperationResult.prototype.setMessage = function(value) {
 ...
 * @return {string}
 */
proto.treum.common.OperationResult.prototype.getErrorCode = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.treum.common.OperationResult} returns this
 */
proto.treum.common.OperationResult.prototype.setErrorCode = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {!jspb.Map<string,string>}
 */
proto.treum.common.OperationResult.prototype.getMetadataMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,string>} */ (
 ...
 * @return {!proto.treum.common.OperationResult} returns this
 */
proto.treum.common.OperationResult.prototype.clearMetadataMap = function() {
  this.getMetadataMap().clear();
  return this;};
