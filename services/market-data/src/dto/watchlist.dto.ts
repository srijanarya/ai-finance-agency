...
export class CreateWatchlistDto {
  ...
  @ApiProperty({ description: 'Custom tags for categorization', type: [String], required: false })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  tags?: string[];
  ...
  @ApiProperty({ description: 'Receive price alerts for this symbol', required: false })
  @IsOptional()
  @IsBoolean()
...
export class UpdateWatchlistDto {
  ...
  @ApiProperty({ description: 'Order/position in the watchlist', required: false })
  @IsOptional()
  @IsNumber()
  sortOrder?: number;
  ...
  @ApiProperty({ description: 'Is this symbol actively monitored', required: false })
  @IsOptional()
  @IsBoolean()
  isActive?: boolean;
...
export class WatchlistResponseDto {
  ...
  @ApiProperty({ description: 'Custom tags for categorization', type: [String] })
  tags: string[];
  ...
  @ApiProperty({ description: 'Price when added to watchlist', required: false })
  addedAtPrice?: number;
...
export class BulkRemoveFromWatchlistDto {
  @ApiProperty({ description: 'Array of watchlist item IDs to remove', type: [String] })
  @IsArray()
...
export class WatchlistStatisticsDto {
  ...
  @ApiProperty({ description: 'Top gaining symbols', type: [WatchlistWithMarketDataDto] })
  topGainers: WatchlistWithMarketDataDto[];

  @ApiProperty({ description: 'Top losing symbols', type: [WatchlistWithMarketDataDto] })
  topLosers: WatchlistWithMarketDataDto[];
}

export class WatchlistImportResultDto {
  @ApiProperty({ description: 'Successfully imported items', type: [WatchlistResponseDto] })
...
export class GetWatchlistByTagsDto {
  @ApiProperty({ description: 'Comma-separated tags to filter by', required: false })
  @IsOptional()
  @IsString()
  tags?: string;
}
